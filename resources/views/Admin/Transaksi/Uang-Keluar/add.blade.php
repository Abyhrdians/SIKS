<div class="modal fade" id="addTransaksi" tabindex="-1" aria-labelledby="addTransaksiLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow">
            ...
            <form action="{{ route('admin.uangkeluar.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body px-4 py-3">
                    ...
                    <div class="mb-3">
                        <label for="file" class="form-label">Lampiran Bukti Pembelian</label>
                        <input type="file" class="form-control" id="file" name="file" accept=".jpg,.jpeg,.png,.pdf">
                        <small class="form-text text-muted">
                            *Wajib dilampirkan dalam format gambar (JPG, PNG) atau PDF. Maksimal 2MB.
                        </small>
                    </div>
                </div>
