            ...
            <form id="editForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body px-4 py-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="edit_nama" name="nama" placeholder="Masukan Nama Transaksi">
                    </div>
                    <div class="mb-3">
                        <label for="jumlah" class="form-label">Jumlah</label>
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" class="form-control" id="edit_jumlah" name="jumlah" placeholder="Masukan Nilai Jumlah">
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="file" class="form-label">Lampiran Bukti Pembelian (Kosongkan Jika tidak ada yang dirubah)</label>
                        <input type="file" class="form-control" id="file" name="file" accept=".jpg,.jpeg,.png,.pdf">
                        <small class="form-text text-muted d-block">
                            *Kosongkan jika tidak ada yang dirubah. Format file: JPG, PNG, atau PDF. Maksimal 2MB.
                        </small>
                    </div>
                </div>
